...
def make_service_definition(svc_conf, vo):
    ...
    url = f"{cluster_endpoint}/system/services/{svc_conf._name}/exposed"
...
def get_services_list(
    ...
    * **public**: whether to retrieve also public services, not specifically tied to
    ...
    for s in json.loads(r.text):
        ...
        cluster_endpoint = MAIN_CONF["oscar"]["clusters"][vo]["endpoint"]
        s['endpoint'] = f"{cluster_endpoint}/system/services/{s['name']}/exposed"
...
def get_service(
    ...
    # Add service endpoint
    cluster_endpoint = MAIN_CONF["oscar"]["clusters"][vo]["endpoint"]
    service['endpoint'] = f"{cluster_endpoint}/system/services/{service_name}/exposed"
